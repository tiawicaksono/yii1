...
class MMenu extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('menu_id, parent_id, menu_status, menu_sort', 'numerical', 'integerOnly' => true),
			array('menu_label, menu_link, menu_icon', 'length', 'max' => 100),
			array('menu_parameter', 'length', 'max' => 20),
			array('menu_condition', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('menu_id, menu_label, menu_link, parent_id, menu_status, menu_icon, menu_parameter, menu_sort, menu_condition', 'safe', 'on' => 'search'),
		);
	}
	 ...
	 * @return MMenu the static model class
	 */

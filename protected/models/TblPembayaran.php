 ...
 */
class TblPembayaran extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('id_rekam_medis', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, id_rekam_medis', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return TblPembayaran the static model class
	 */

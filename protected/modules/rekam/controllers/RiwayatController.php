...
//        $sheet->mergeCells("C18:J18");
        ...
        $sheet->setCellValue("C13", ": " . date("d F Y", strtotime($data->jdatang)));
        ...
        $sheet->getStyle("C15")->applyFromArray($styleTengahHorizontal);
...
//        $sheet->getStyle("H19")->applyFromArray($styleTengahHorizontal);
        ...
        $sheet->setCellValue("C21", ": Rp." . number_format($data->b_berkala + $data->b_rekom, 0));
        ...
        $sheet->mergeCells("E62:J62");
        $sheet->mergeCells("E63:J63");
        $sheet->mergeCells("E64:J64");
        
        $sheet->setCellValue("A64", "6");
        $sheet->getStyle("A64")->applyFromArray($styleTengah);
        $sheet->getStyle("E64")->applyFromArray($styleBold11);
        $sheet->setCellValue("A65", "7");
        $sheet->getStyle("A65")->applyFromArray($styleTengah);
        $sheet->mergeCells("B64:D64");
        $sheet->mergeCells("B65:D65");
        ...
        $sheet->setCellValue("E57", ": " . $data->selgaya1 . " %");
        ...
        $sheet->setCellValue("E59", ": " . $data->selgaya2 . " %");
...
//        $sheet->setCellValue("A69", "e.");
        ...
        $sheet->setCellValue("B68", "Tgl Mati Uji 6 Bln Kedepan");
        $sheet->getStyle("B68")->applyFromArray($styleTengahHorizontal);
        $sheet->getStyle("B68")->getAlignment()->setWrapText(true);
...
//        $sheet->getStyle("B69")->applyFromArray($styleTengahHorizontal);
        ...
        $sheet->setCellValue("C68", ": " . date("d F Y", strtotime($data->tglmati6bln)));
...
//        $sheet->getStyle("C69")->applyFromArray($styleTengahHorizontal);
        ...
        $sheet->setCellValue("G68", "Lama Proses");
        $sheet->getStyle("G68")->applyFromArray($styleTengahHorizontal);

        $sheet->mergeCells("E65:J65");
        ...
        $sheet->setCellValue("H68", ": " . $data->lama . " menit");

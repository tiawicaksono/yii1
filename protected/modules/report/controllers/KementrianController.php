     ...
     */
         ...
         */
                ...
                for ($bln = 1; $bln <= 12; $bln++) :
                        //======================================================================
                        $sqlBarang = "SELECT count(*) AS total FROM v_kementrian_kbwu vrkt "
                                . "LEFT OUTER JOIN tbl_jns_kend b ON (vrkt.id_jns = b.id_jns_kend) "
                                . "WHERE vrkt.bulan = " . $bln . " ::double precision AND vrkt.tahun = " . $tahun . " ::double precision AND id_jns = 0";
                        $dataBarang = Yii::app()->db->createCommand($sqlBarang)->queryRow();
                        //======================================================================
                        $sqlPenumpang = "SELECT count(*) AS total FROM v_kementrian_kbwu vrkt "
                                . "LEFT OUTER JOIN tbl_jns_kend b ON (vrkt.id_jns = b.id_jns_kend) "
                                . "WHERE vrkt.bulan = " . $bln . " ::double precision AND vrkt.tahun = " . $tahun . " ::double precision AND id_jns = 1";
                        $dataPenumpang = Yii::app()->db->createCommand($sqlPenumpang)->queryRow();
                        //======================================================================
                        $sqlBis = "SELECT count(*) AS total FROM v_kementrian_kbwu vrkt "
                                . "LEFT OUTER JOIN tbl_jns_kend b ON (vrkt.id_jns = b.id_jns_kend) "
                                . "WHERE vrkt.bulan = " . $bln . " ::double precision AND vrkt.tahun = " . $tahun . " ::double precision AND id_jns = 2";
                        $dataBis = Yii::app()->db->createCommand($sqlBis)->queryRow();
                        //======================================================================
                        $sqlTraktor = "SELECT count(*) AS total FROM v_kementrian_kbwu vrkt "
                                . "LEFT OUTER JOIN tbl_jns_kend b ON (vrkt.id_jns = b.id_jns_kend) "
                                . "WHERE vrkt.bulan = " . $bln . " ::double precision AND vrkt.tahun = " . $tahun . " ::double precision AND id_jns = 3";
                        $dataTraktor = Yii::app()->db->createCommand($sqlTraktor)->queryRow();
                        //======================================================================
                        $sqlGandengan = "SELECT count(*) AS total FROM v_kementrian_kbwu vrkt "
                                . "LEFT OUTER JOIN tbl_jns_kend b ON (vrkt.id_jns = b.id_jns_kend) "
                                . "WHERE vrkt.bulan = " . $bln . " ::double precision AND vrkt.tahun = " . $tahun . " ::double precision AND id_jns = 4";
                        $dataGandengan = Yii::app()->db->createCommand($sqlGandengan)->queryRow();
                        //======================================================================
                        $sqlTempelan = "SELECT count(*) AS total FROM v_kementrian_kbwu vrkt "
                                . "LEFT OUTER JOIN tbl_jns_kend b ON (vrkt.id_jns = b.id_jns_kend) "
                                . "WHERE vrkt.bulan = " . $bln . " ::double precision AND vrkt.tahun = " . $tahun . " ::double precision AND id_jns = 5";
                        $dataTempelan = Yii::app()->db->createCommand($sqlTempelan)->queryRow();
                        //======================================================================
                        $sqlCurah = "SELECT count(*) AS total FROM v_kementrian_kbwu vrkt "
                                . "LEFT OUTER JOIN tbl_jns_kend b ON (vrkt.id_jns = b.id_jns_kend) "
                                . "WHERE vrkt.bulan = " . $bln . " ::double precision AND vrkt.tahun = " . $tahun . " ::double precision AND id_jns = 6";
                        $dataCurah = Yii::app()->db->createCommand($sqlCurah)->queryRow();
                        //======================================================================
                        $sqlDinas = "SELECT count(*) AS total FROM v_kementrian_kbwu vrkt "
                                . "LEFT OUTER JOIN tbl_jns_kend b ON (vrkt.id_jns = b.id_jns_kend) "
                                . "WHERE vrkt.bulan = " . $bln . " ::double precision AND vrkt.tahun = " . $tahun . " ::double precision AND id_jns = 7";
                        $dataDinas = Yii::app()->db->createCommand($sqlDinas)->queryRow();
                        //======================================================================

                        $sheet->setCellValue("A" . $baris, $no);
                        $sheet->setCellValue("B" . $baris, Yii::app()->params['bulanArrayInd'][$bln - 1]);
                        $sheet->setCellValue("C" . $baris, $dataPenumpang['total']);
                        $sheet->setCellValue("D" . $baris, $dataBis['total']);
                        $sheet->setCellValue("E" . $baris, $dataDinas['total']);
                        $sheet->setCellValue("F" . $baris, $dataBarang['total']);
                        $sheet->setCellValue("G" . $baris, $dataGandengan['total']);
                        $sheet->setCellValue("H" . $baris, $dataTempelan['total']);
                        $sheet->setCellValue("I" . $baris, $dataTraktor['total']);
                        $sheet->setCellValue("J" . $baris, $dataCurah['total']);
                        $baris++;
                        $no++;
                endfor;
                ...
                $sheet->getStyle("A6:J" . $baris)->applyFromArray($styleBorder);

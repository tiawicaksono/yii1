            ...
            <div class="box-body">
                <div class="col-md-12">
                    ...
                    <div class="col-lg-3 no-padding">
                        <button type="button" id="bulan" class="btn btn-success" onclick="cetak('<?php echo $this->createUrl('Pendapatan/Rekap'); ?>',this.id,'bulan')">
                ...
                <div class="col-md-12" style="margin-top: 20px; ">
                    ...
                    <div class="col-lg-3 no-padding">
                        <button type="button" id="tahun" class="btn btn-success" onclick="cetak('<?php echo $this->createUrl('Pendapatan/Rekap'); ?>',this.id,'tahun')">

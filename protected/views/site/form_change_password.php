    ...
    <div class="box-body">
        <div class="col-md-6">
            ...
            <div class="form-group">
                <label for="new_password" class="col-lg-3 col-md-6 control-label">Password Baru</label>
...
<!--            <div class="form-group">
                <label for="confirm_password" class="col-lg-3 col-md-6 control-label">Confirm Password</label>
                <div class="col-lg-6 col-md-6">
                    <?php
//                    echo CHtml::passwordField('confirm_password', '', array('class' => 'form-control'));
                    ?>
                </div>
            </div>-->
            <div class="form-group">
                ...
                <div class="col-lg-6 col-md-6">
                    <button type="button" class="btn btn-primary" onclick="submitForm('<?php echo $this->createUrl('Site/ChangePassword'); ?>')">Change Password</button>
                </div>
            </div>
...
<script>
    ...
    $(document).on("keypress", '#formChangePassword', function (e) {
        ...
        if (code == 13) {
            submitForm('<?php echo $this->createUrl('Site/ChangePassword'); ?>');
            return false;
        }
    });
</script>